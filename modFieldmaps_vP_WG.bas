Attribute VB_Name = "modFieldmaps_vP_WG"
Option Base 0
Option Explicit
...
Public Type SpellRecType
    ...
    N06 As Integer
End Type
Const SpellDataBufSize = 253
Public SpellFldMap(0 To 70) As FieldMap
...
End Type
Const MonsterDataBufSize = 732
Public MonsterFldMap(0 To 174) As FieldMap
...
Public Type ItemRecType
    ...
    'unknown20(1)   As Byte
End Type
Const ItemDataBufSize = 1061 '1948 '1072
Public ItemFldMap(0 To 168) As FieldMap '188
...
Public Type ShopRecType
    ...
    ShopDescriptionA        As String * 51      '97
    ShopNothing1            As Integer          '98
    ShopDescriptionB        As String * 51      '150
    ShopNothing2            As Integer          '151
    ShopDescriptionC        As String * 51      '203
...
Public Type RoomRecType
    ...
    Type                As Byte              '1056
    NewSpot             As Byte                                '***I_THROUGH_N*** (comment for n)
    ...
    Delay               As Integer
    MaxArea             As Integer
    Nothing11           As Integer
    ControlRoom         As Long
    PermNPC             As Long
    PlacedItems(9)      As Long
    Nothing12(2)        As Integer          ' -3
    Nothing12a          As Byte
    Something1          As Byte
    Spell               As Long
...
Const RoomDataBufSize = 1528 '1544
'Const RoomDataBufSize = 1512 '***I_THROUGH_N*** (UNcomment for n)

Public RoomFldMap(0 To 248) As FieldMap     '***I_THROUGH_N*** (comment for n)
...
'====> TEXTBLOCKS
Public Const TextblockLeadInSize = 12
...
Public Type TextblockRecType
    ...
    Data As String * 2000
End Type
Public Const TextblockMaxBufSize = 2022
Public TextblockFldMap(0 To 15) As FieldMap
...
Public Type TextblockKeyType
    ...
    Number As Long
End Type
' This approach required because of issues with Long datatypes and byte sequencing with VB6
...
Public Type UserRecType
    ...
    unknown9(14) As Integer  'unknown
    ...
    unknownStuff0(12) As Byte       ' maybe profile options?
    bEDITED As Byte                 ' sys tweak edit-ed
    unknownStuff1(7) As Byte        ' maybe profile options?
    CharLifeMins1 As Integer
    unknownStuff2(44) As Byte       ' maybe profile options?
    Ability(29) As Integer          ' quest flags
    AbilityModifier(29) As Integer  ' quest flag modifier
    unknownStuff3(12) As Byte       ' maybe profile options?
    CharLifeMins2 As Long
    unknownStuff4(34) As Byte       ' maybe profile options?
End Type
Const UserDataBufSize = 1998 '2028
Public UserFldMap(0 To 790) As FieldMap
...
Public Type BankrecType
    ...
    Cash As Long
End Type
Const BankDatabufSize = 72
Public BankFldMap(0 To 2) As FieldMap
...
Public Type BankKeyType
    ...
    ShopNumber As Long
End Type
Const BankKeyDataBufSize = 34
Public BankKeyFldMap(0 To 1) As FieldMap
...
' FileVersion not in the specs (BPREFER.PDF, PG53).
' Reordering per specs (BPREFER.PDF, PG53).
Public UpdateFileSpecs As UpdateFileSpecTypeWG
Public Type UpdateFileSpecTypeWG
    'FileSpec
...
Public Const UpdateDataBufSize = 2022 '2024
...
Public Function InitUpdateFile() As Integer
    ...
    UpdateFileSpecs.RecordLength = 2015
    UpdateFileSpecs.PageSize = 2048
    UpdateFileSpecs.IndexCount = 1
    UpdateFileSpecs.FileFlags = NO_INCLUDE_SYSTEM_DATA
    UpdateFileSpecs.DuplicatePointCount = 0
    UpdateFileSpecs.Allocation = 0
    UpdateFileSpecs.KeyPosition = 1
    UpdateFileSpecs.KeyLength = 4
    UpdateFileSpecs.KeyFlags = EXTTYPE
    UpdateFileSpecs.ExtDataType = BAUTOINC
    UpdateFileSpecs.NullValue = 0
    UpdateFileSpecs.ManKeyNumber = 0
    UpdateFileSpecs.ACSNumber = 0
    
    ' check for correct create settings in the registry for v5...
    If Not GetBTRCreateIsV5() Then
        msgstr = "**** READ THIS ****" & vbCrLf & vbCrLf & _
            "MajorMUD 1.11p-WG requires BTRIEVE v5 databases." & vbCrLf & _
            "BTRIEVE v6 creates databases as v6 by default." & vbCrLf & _
            "Your BTRIEVE registry settings were either incorrect or missing." & vbCrLf & _
            "The '" & BTRV_CREATE_KEY_VALUE_NAME & "' registry key value forces v5 DBs." & vbCrLf & vbCrLf

        If SetBTRCreateV5(True) <> 0 Then
            msgstr = msgstr & _
                "I was UNABLE to change your registry settings to BTRIEVE v5." & vbCrLf & _
                "Check your path, permissions, and value on the following key path / value:" & _
                vbCrLf & vbCrLf & _
                "HKLM\\" & BTRV_CREATE_KEY_PATH & vbCrLf & _
                "Add registry value '" & BTRV_CREATE_KEY_VALUE_NAME & "' as a string and set to '1'." & vbCrLf & vbCrLf
        Else
            msgstr = msgstr & msgstr_success
        End If
        
        msgstr = msgstr & msgstr_restart
        nYesNo = MsgBox(msgstr, vbOK, "MajorMUD 1.11p-WG BTRIEVE v5 Check")
        nStatus = 1
    Else
        nStatus = BTRCALL(BCREATE, UpdatePosBlock, UpdateFileSpecs, UpdateFileSpecSize, ByVal UpdateKeyBuffer, KEY_BUF_LEN, 0)
    End If
...
Sub AddUserFieldMap(Map() As FieldMap, ByRef ctr As Integer)
    ...
    AddField Map, ctr, FLD_INTEGER, 2   'mr
    AddField Map, ctr, FLD_INTEGER, 4   'MapNum
    AddField Map, ctr, FLD_INTEGER, 4   'RoomNum
    AddField Map, ctr, FLD_INTEGER, 2   'nothing
    AddField Map, ctr, FLD_INTEGER, 2   '?
    AddField Map, ctr, FLD_INTEGER, 2   '?
    AddField Map, ctr, FLD_INTEGER, 2   'nothing
    ...
    AddField Map, ctr, FLD_INTEGER, 1 'nothing5
    ...
    AddField Map, ctr, FLD_INTEGER, 1 'Nothing6
    ...
    AddField Map, ctr, FLD_INTEGER, 2 'EvilPoints
    AddField Map, ctr, FLD_INTEGER, 4 'Nothing7
    AddField Map, ctr, FLD_INTEGER, 4 'Nothing7
    AddField Map, ctr, FLD_INTEGER, 1 'Nothing7a
    ...
    AddField Map, ctr, FLD_INTEGER, 1 'nothing8
    AddField Map, ctr, FLD_INTEGER, 2 'broadcast chan
    AddField Map, ctr, FLD_BYTE, 3    'unknown5
    ...
    AddField Map, ctr, FLD_INTEGER, 2 'unknown
    AddField Map, ctr, FLD_INTEGER, 2 'LivesRemaining
    ...
    AddField Map, ctr, FLD_INTEGER, 2
    AddField Map, ctr, FLD_INTEGER, 2
    'AddField Map, ctr, FLD_INTEGER, 2 'unknown9 16
    ...
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    ...
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff0_13    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   ' bEDITED
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    ...
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff1_8     ' maybe profile options?
    AddField Map, ctr, FLD_INTEGER, 2 ' CharLifeMins1
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff2_45    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff2_45    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff2_45    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff2_45    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff2_45    ' maybe profile options?
    ...
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff    ' maybe profile options?
    AddField Map, ctr, FLD_BYTE, 1   'unknownStuff    ' maybe profile options?
...
Sub AddSpellFieldMap(Map() As FieldMap, ByRef ctr As Integer)
    ...
    AddField Map, ctr, FLD_BYTE, 1    '
    'AddField Map, ctr, FLD_INTEGER, 2 'N01
    AddField Map, ctr, FLD_INTEGER, 4 'Cast MsgA
    AddField Map, ctr, FLD_INTEGER, 2 'N02_0
    AddField Map, ctr, FLD_INTEGER, 2 'N02_1
    AddField Map, ctr, FLD_INTEGER, 2 'N02_2
    AddField Map, ctr, FLD_INTEGER, 2 'N02_3
    AddField Map, ctr, FLD_INTEGER, 2 'N02_4
    AddField Map, ctr, FLD_INTEGER, 2 'N02_5
    AddField Map, ctr, FLD_INTEGER, 2 'N02_6
    AddField Map, ctr, FLD_INTEGER, 2 'N02_7
    AddField Map, ctr, FLD_INTEGER, 2 'N02_8
    AddField Map, ctr, FLD_INTEGER, 2 'N02_9
    'AddField Map, ctr, FLD_INTEGER, 2 '10
    AddField Map, ctr, FLD_BYTE, 1    'N02a
    AddField Map, ctr, FLD_BYTE, 1    'SLevelCap
    AddField Map, ctr, FLD_BYTE, 1    'N03
    AddField Map, ctr, FLD_BYTE, 1    'MsgStyle
    AddField Map, ctr, FLD_BYTE, 1    '
    AddField Map, ctr, FLD_BYTE, 1    '
    AddField Map, ctr, FLD_BYTE, 1    '
    ...
    AddField Map, ctr, FLD_INTEGER, 2 'SpellType
    AddField Map, ctr, FLD_INTEGER, 1 'TypeOfResists
    ...
    AddField Map, ctr, FLD_INTEGER, 1 'ResistAbility
    AddField Map, ctr, FLD_INTEGER, 2 'MageryA
    ...
    AddField Map, ctr, FLD_BYTE, 1    '
    AddField Map, ctr, FLD_BYTE, 1    '
    AddField Map, ctr, FLD_STRING, 5  'ShortName
    AddField Map, ctr, FLD_BYTE, 1    'AfterShortName
    AddField Map, ctr, FLD_INTEGER, 2 'N06
End Sub
...
Sub AddMonsterFieldMap(Map() As FieldMap, ByRef ctr As Integer)
    ...
    'AddField Map, ctr, FLD_INTEGER, 2
    AddField Map, ctr, FLD_INTEGER, 2   'exp multi
    AddField Map, ctr, FLD_INTEGER, 2
    AddField Map, ctr, FLD_INTEGER, 2   'Index
    AddField Map, ctr, FLD_INTEGER, 2
    AddField Map, ctr, FLD_INTEGER, 2   'Something
    ...
    AddField Map, ctr, FLD_INTEGER, 2   'MR
    AddField Map, ctr, FLD_INTEGER, 1   'BSDefence
    ...
    AddField Map, ctr, FLD_INTEGER, 2   'CharmRes           As Integer
    AddField Map, ctr, FLD_INTEGER, 1   'Nothing21           As Integer
...
Sub AddItemFieldMap(Map() As FieldMap, ByRef ctr As Integer)
    ...
    AddField Map, ctr, FLD_INTEGER, 2       'Weapon
    AddField Map, ctr, FLD_INTEGER, 2       'Armour
    AddField Map, ctr, FLD_INTEGER, 1       'Wornon
...
'    AddField map, ctr, FLD_INTEGER, 2       '18
    ...
    AddField Map, ctr, FLD_INTEGER, 1   'unknown14
    AddField Map, ctr, FLD_INTEGER, 2       'AbilityB 1
    AddField Map, ctr, FLD_INTEGER, 2       '2
    AddField Map, ctr, FLD_INTEGER, 2       '3
    AddField Map, ctr, FLD_INTEGER, 2       '4
    AddField Map, ctr, FLD_INTEGER, 2       '5
    ...
    'AddField Map, ctr, FLD_BYTE, 1      'uknown19
'    AddField map, ctr, FLD_BYTE, 1      '
'    AddField map, ctr, FLD_BYTE, 1      '
'    AddField map, ctr, FLD_BYTE, 1      '
'    AddField map, ctr, FLD_BYTE, 1      '
...
Sub AddShopFieldMap(Map() As FieldMap, ByRef ctr As Integer)
    ...
    AddField Map, ctr, FLD_INTEGER, 2   '
    AddField Map, ctr, FLD_STRING, 51   'SDescA
    AddField Map, ctr, FLD_INTEGER, 2   'Nothing
    AddField Map, ctr, FLD_STRING, 51   'SDescB
    AddField Map, ctr, FLD_INTEGER, 2   'Nothing
    AddField Map, ctr, FLD_STRING, 51   'SDescC
    AddField Map, ctr, FLD_INTEGER, 1   'Nothing
...
'    AddField Map, ctr, FLD_INTEGER, 2   'current mons 15        '***I_THROUGH_N*** (UNcomment for n)
    ...
    AddField Map, ctr, FLD_INTEGER, 1   'Type
    AddField Map, ctr, FLD_INTEGER, 1   'new spot                '***I_THROUGH_N*** (comment for n)
    ...
    AddField Map, ctr, FLD_INTEGER, 2   'MaxRegen
    AddField Map, ctr, FLD_INTEGER, 1   'unknown6a
    AddField Map, ctr, FLD_INTEGER, 2   'MonsterType
    AddField Map, ctr, FLD_INTEGER, 2   'unknown6b
    AddField Map, ctr, FLD_INTEGER, 4   'Attributes
    AddField Map, ctr, FLD_INTEGER, 4   'nothing9
    ...
    AddField Map, ctr, FLD_INTEGER, 2   'Nothing11
    ...
    AddField Map, ctr, FLD_INTEGER, 2   'Nothing12_0
    AddField Map, ctr, FLD_INTEGER, 2   'Nothing12_1
    AddField Map, ctr, FLD_INTEGER, 2   'Nothing12_2
    AddField Map, ctr, FLD_INTEGER, 1   'Nothing12a
    AddField Map, ctr, FLD_INTEGER, 1   'Something1
